    ...
    <>
      <nav className={styles.navbar}>
        ...
        <ul className={styles.navbarLinks}>
          ...
          <li key="Tools">
            <Link to="/tools" className={styles.navbarLink}>
              Tools
            </Link>
          </li>
          <li key="Blogs">
          ...
          {user ? (
            <>
              ...
              <li key="Delete">
                <button onClick={handleDelete} className={styles.navbarButton}>
                  Delete Account
                </button>
              </li>
              <li key="Profile">
            ...
            <>
              <li key="Login">
                <Link to="/auth/login" className={styles.navbarLink}>
                  Login
                </Link>
              </li>
              <li key="Register">
                <Link to="/auth/register" className={styles.navbarLink}>
                  Register
                </Link>
              </li>
            </>
