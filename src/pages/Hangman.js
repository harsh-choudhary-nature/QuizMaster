...
const HangmanGame = () => {
    const hardcodedWord = "SERENDIPITY"; // Can be changed to a dynamic word daily if needed.
    const wordHint = "The occurrence of events by chance in a happy or beneficial way";
